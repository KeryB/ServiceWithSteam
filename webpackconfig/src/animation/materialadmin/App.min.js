...
(function (namespace, $) {
    ...
    p._handleMenuLinkClick = function (e) {
        var pinned = ($('body').hasClass('menubar-pin') && materialadmin.App.minBreakpoint('md'));
        var expanded = $('#menubar').data('expanded');
        if (expanded === false && pinned === false) {
            e.preventDefault();
        }
    };
...
(function (namespace, $) {
    ...
    p._initSortables = function () {
        ...
        $('[data-sortable="true"]').sortable({
            placeholder: "ui-state-highlight", delay: 100, start: function (e, ui) {
